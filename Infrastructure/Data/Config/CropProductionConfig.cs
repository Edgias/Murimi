...
namespace NigTech.Murimi.Infrastructure.Data.Config
{
    internal class CropProductionConfig : BaseEntityConfig<CropProduction>
    {
        public override void Configure(EntityTypeBuilder<CropProduction> builder)
        {
            ...
            IMutableNavigation? cropProductionFieldNavigation = 
                builder.Metadata.FindNavigation(nameof(CropProduction.CropProductionFields));
            cropProductionFieldNavigation?.SetPropertyAccessMode(PropertyAccessMode.Field);

            IMutableNavigation? cropProductionVarietyNavigation = 
                builder.Metadata.FindNavigation(nameof(CropProduction.CropProductionVarieties));
