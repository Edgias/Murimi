...
namespace NigTech.Murimi.ApplicationCore.Entities
{
    public class Field : BaseEntity, IAggregateRoot
    {
        ...
        public FieldMeasurement FieldMeasurement { get; private set; } = null!;
        ...
        public Field(string name, Guid? locationId, Guid fieldMeasurementId, decimal usableArea, 
            Guid? soilTypeId, Guid? ownershipTypeId)
        {
