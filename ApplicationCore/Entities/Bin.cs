...
namespace NigTech.Murimi.ApplicationCore.Entities
{
    public class Bin : BaseEntity, IAggregateRoot
    {
        ...
        public BinType BinType { get; private set; } = null!;
        ...
        public UnitMeasurement UnitMeasurement { get; private set; } = null!;

        public Guid WarehouseId { get; private set; }

        public Warehouse Warehouse { get; private set; } = null!;

        public Bin(string name, decimal capacity, Guid binTypeId, Guid unitGroupId, 
            Guid unitMeasurementId, Guid warehouseId)
        {
